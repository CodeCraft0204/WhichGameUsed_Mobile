...
const items = [
  ...
  { key: 'authenticate', label: 'SUBMIT', href: '/authenticate/authenticate' as Href, icon: figmaIcons.navAuthenticate },
  ...
  { key: 'more', label: 'MUCH MORE', href: '/education/education' as Href, icon: figmaIcons.navMore }
] as const;
